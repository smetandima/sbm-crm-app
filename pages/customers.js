          ...
          <div className="page__center">
            <div className="page__row page__row_head">
              <div className="page__col">
                ...
                <div className="page__welcome h2">Welcome back<span className="desktop-hide">👋</span></div>
              </div>
              <div className="page__col">
                <div className="header"><button className="header__burger" />
                  <div className="search">
                    ...
                    <div className="search__result">
                      <div className="search__info caption-sm">Recent Searches</div><div className="page__wrapper">
  <div className="page__center">
    <div className="page__row page__row_head">
      <div className="page__col">
        <div className="page__hello h5">Hi David,</div>
            ...
            <div className="page__content">
              <div className="banner">
                <div className="banner__container">
                  <div className="banner__preview"><img className="banner__pic" src="img/banner-pic.png"/></div>
                  <div className="banner__wrap">
                    <div className="banner__title h3">Your Products</div>
                    <div className="banner__text">Create Your Product Dashboard in Minutes</div><button className="banner__btn btn btn_white">Check all settings</button>
                  </div>
                </div>
              </div>
                  ...
                  <div className="products__table">
                    ...
                    <div className="products__row">
                      ...
                      <div className="products__cell"><a className="products__item" href="#">
                          ...
                          <div className="products__details">
                            <div className="products__title title">Abstract 3D Kit</div>
                            <div className="products__info caption color-gray">3D Illustration</div>
                          </div>
                        </a></div>
                      ...
                      <div className="products__cell">
                        <div className="products__color">
                          <div className="products__bg" style={{backgroundColor: '#6C5DD3'}} />
                        ...
                        <div className="products__cost">
                          ...
                          <div className="products__tooltip">
                            <div className="products__sale">
                              ...
                              <div className="products__caption caption-sm">Latest Sale</div>
                            </div>
                      ...
                      <div className="products__cell">
                        <div className="products__rating"><span className="color-green">5.0</span> (45 votes)</div>
                      </div>
                    </div>
                    ...
                    <div className="products__row">
                      ...
                      <div className="products__cell"><a className="products__item" href="#">
                          <div className="products__preview"><img className="products__pic" src="img/product-pic.png"/></div>
                          <div className="products__details">
                            <div className="products__title title">Sapiens Illustration</div>
                            <div className="products__info caption color-gray">3D Illustration</div>
                          </div>
                        </a></div>
                      <div className="products__cell">
                      ...
                      <div className="products__cell">
                        <div className="products__color">
                          <div className="products__bg" style={{backgroundColor: '#7FBA7A'}} />
                    ...
                    <div className="products__row">
                      ...
                      <div className="products__cell"><a className="products__item" href="#">
                          <div className="products__preview"><img className="products__pic" src="img/product-pic.png"/></div>
                          <div className="products__details">
                            <div className="products__title title">Collab Landing Page</div>
                            <div className="products__info caption color-gray">3D Illustration</div>
                          </div>
                        </a></div>
                      <div className="products__cell">
                      ...
                      <div className="products__cell">
                        <div className="products__color">
                          <div className="products__bg" style={{backgroundColor: '#FFCE73'}} />
                    ...
                    <div className="products__row">
                      ...
                      <div className="products__cell">
                        <div className="products__color">
                          <div className="products__bg" style={{backgroundColor: '#FFA2C0'}} />
